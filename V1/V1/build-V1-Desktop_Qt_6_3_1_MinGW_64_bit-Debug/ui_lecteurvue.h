...
public:
    ...
    void setupUi(QMainWindow *LecteurVue)
    {
        ...
        lImage->setPixmap(QPixmap(QString::fromUtf8(":/v2/cartesDisney/Disney_tapisOld.png")));
    ...
    void retranslateUi(QMainWindow *LecteurVue)
    {
        ...
        CBMode->setItemText(1, QCoreApplication::translate("LecteurVue", "Mode Automatique", nullptr));
